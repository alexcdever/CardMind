...
| SP-POOL-003 | pool_spec.md | Pool 模型 CRUD 规格 | 📝 待写 |
| SP-CARD-004 | card_store_spec.md | CardStore 改造规格 | 📝 待写 |
| SP-API-005 | api_spec.md | API 层统一规格 | 📝 待写 |
| SP-SYNC-006 | sync_spec.md | 同步层简化规格 | 📝 待写 |
...
| SP-FLUT-007 | onboarding_spec.md | 初始化流程规格 | 📝 待写 |
| SP-FLUT-008 | home_screen_spec.md | 主页交互规格 | 📝 待写 |
...
1. **高优先级**
   - [ ] 修改 Rust 数据模型（按照 SP-SPM-001）
   - [ ] 更新 DeviceConfig（按照 SP-DEV-002）
   - [ ] 修改 Flutter UI（按照 SP-FLUT-003）

2. **中优先级**
   - [ ] 补充 Pool/CardStore 规格
   - [ ] 完善集成测试
   - [ ] 添加更多业务示例
...
- [系统架构](../docs/architecture/system_design.md) - 架构概述
