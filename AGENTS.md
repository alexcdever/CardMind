...
This project is indexed by GitNexus as **CardMind** (8089 symbols, 17049 relationships, 297 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
