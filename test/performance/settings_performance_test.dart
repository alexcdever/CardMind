  ...
  group('Settings Performance Tests', () {
    ...
    testWidgets('PT-001: Toggle component renders within 300ms', (
      ...
      await tester.pumpWidget(
        createToggleWidget(value: value, onChanged: (v) => value = v),
      );
      ...
      expect(
        ...
        lessThan(700),
        reason: 'Toggle component should render within 700ms',
      );
    });
    ...
    testWidgets('PT-002: Toggle switch responds within 100ms', (
      ...
      expect(
        stopwatch.elapsedMilliseconds,
        lessThan(150),
        reason: 'Toggle should respond within 150ms',
      );
    });
    ...
    testWidgets('PT-003: Button component renders within 300ms', (
      ...
      await tester.pumpWidget(createButtonWidget(onPressed: () {}));
      await tester.pumpAndSettle();
    ...
    testWidgets('PT-008: Dialog opening is fast', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: Builder(
              builder: (context) => ElevatedButton(
                onPressed: () {
                  showDialog<void>(
                    context: context,
                    builder: (_) => const ExportConfirmDialog(cardCount: 100),
                  );
                },
      ...
      expect(
        stopwatch.elapsedMilliseconds,
        lessThan(300),
        reason: 'Dialog should open within 300ms',
      );
    });
    ...
    testWidgets('PT-009: Memory usage is reasonable', (
      ...
      for (int i = 0; i < 5; i++) {
        await tester.pumpWidget(
          createToggleWidget(value: false, onChanged: (_) {}),
        );
        await tester.pumpAndSettle();
