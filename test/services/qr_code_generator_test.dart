...
void main() {
  group('QRCodeGenerator Tests', () {
    test('generates valid QR code bytes', () async {
    ...
    test('generated QR code can be decoded', () async {
      // 生成二维码
      final bytes = await QRCodeGenerator.generatePairingQRCode(
        peerId: '12D3KooWTest123456789',
        deviceName: 'Test Device',
    ...
    test('generates QR code with multiple multiaddrs', () async {
      final bytes = await QRCodeGenerator.generatePairingQRCode(
        peerId: '12D3KooWTest123456789',
        deviceName: 'Test Device',
        deviceType: 'laptop',
    ...
    test('generates QR code for different device types', () async {
    ...
    test('generates QR code with timestamp', () async {
