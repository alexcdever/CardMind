  ...
  group('SP-UI-002: Card Editor UI', () {
    ...
    group('UI Layout Tests', () {
      ...
      testWidgets('it_should_display_placeholder_text_in_content_field',
        ...
        // Then: 显示占位符文本
        final contentField =
            tester.widget<TextField>(find.byKey(const Key('content_field')));
        expect(contentField.decoration?.hintText,
            equals('输入内容（支持 Markdown）'));
      });
    });
    ...
    group('Input Field Tests', () {
      ...
      testWidgets('it_should_accept_text_input_in_title_field',
        ...
        await tester.enterText(
            find.byKey(const Key('title_field')), 'Test Title');
        await tester.pump();
      ...
      testWidgets('it_should_accept_text_input_in_content_field',
        ...
        // When: 用户输入文本
        await tester.enterText(
            find.byKey(const Key('content_field')), 'Test Content');
        await tester.pump();
      ...
      testWidgets('it_should_accept_markdown_syntax_in_content_field',
        ...
        await tester.enterText(find.byKey(const Key('content_field')), markdown);
        await tester.pump();
    ...
    group('Button State Tests', () {
      testWidgets('it_should_disable_complete_button_when_title_empty',
        ...
        // When: 检查完成按钮状态
        final button =
            tester.widget<TextButton>(find.byKey(const Key('complete_button')));
      ...
      testWidgets('it_should_disable_complete_button_for_whitespace_only_title',
          (WidgetTester tester) async {
        // Given: 标题只包含空格
        await tester.pumpWidget(createEditorWithMockApi());
        await tester.pumpAndSettle();
      ...
      testWidgets('it_should_enable_back_button_always',
        ...
        // When: 检查返回按钮状态
        final button =
            tester.widget<IconButton>(find.byKey(const Key('back_button')));
    ...
    group('Navigation Tests', () {
      testWidgets('it_should_show_discard_dialog_when_back_pressed_with_changes',
          (WidgetTester tester) async {
        // Given: 用户有未保存的更改
        await tester.pumpWidget(createEditorWithMockApi());
        await tester.pumpAndSettle();
    ...
    group('Performance Tests', () {
      ...
      testWidgets('it_should_handle_rapid_text_input_without_lag',
        ...
        for (int i = 0; i < 10; i++) {
          await tester.enterText(
              find.byKey(const Key('title_field')), 'Text $i');
          await tester.pump();
        }
