...
void main() {
  group('SP-FLUT-009: Card Creation Interaction', () {
    ...
    group('FAB Button Tests', () {
      ...
      testWidgets('it_should_navigate_to_editor_when_fab_tapped', (
        WidgetTester tester,
      ) async {
    ...
    group('Input Field Tests', () {
      testWidgets('it_should_focus_title_field_on_editor_load', (
        WidgetTester tester,
      ) async {
        // Given: 卡片编辑器即将加载
      ...
      testWidgets('it_should_display_title_and_content_fields', (
        WidgetTester tester,
      ) async {
        // Given: 用户进入卡片编辑器
        await tester.pumpWidget(createEditorWithMockApi());
      ...
      testWidgets('it_should_show_placeholder_for_empty_title', (
        WidgetTester tester,
      ) async {
        // Given: 标题字段为空
        await tester.pumpWidget(createEditorWithMockApi());
      ...
      testWidgets('it_should_show_placeholder_for_empty_content', (
        WidgetTester tester,
      ) async {
        // Given: 内容字段为空
        await tester.pumpWidget(createEditorWithMockApi());
      ...
      testWidgets('it_should_capture_markdown_content', (
        WidgetTester tester,
      ) async {
        // Given: 用户在内容字段
        await tester.pumpWidget(createEditorWithMockApi());
    ...
    group('Auto-save Tests', () {
      testWidgets('it_should_trigger_autosave_after_500ms_inactivity', (
        WidgetTester tester,
      ) async {
        // Given: 用户停止输入
        await tester.pumpWidget(createEditorWithMockApi());
    ...
    group('Validation Tests', () {
      testWidgets('it_should_validate_empty_title', (
        WidgetTester tester,
      ) async {
        // Given: 标题为空
        await tester.pumpWidget(createEditorWithMockApi());
      ...
      testWidgets('it_should_reject_whitespace_only_title', (
        WidgetTester tester,
      ) async {
        // Given: 标题只包含空格
        await tester.pumpWidget(createEditorWithMockApi());
      ...
      testWidgets('it_should_validate_title_length', (
        WidgetTester tester,
      ) async {
        // Given: 标题超过 200 字符
        await tester.pumpWidget(createEditorWithMockApi());
        ...
        final TextField titleField = tester.widget(
          find.byKey(const Key('title_field')),
        );
    ...
    group('Error Handling Tests', () {
      testWidgets('it_should_show_error_snackbar_on_network_failure', (
        WidgetTester tester,
      ) async {
        // Given: 网络连接失败
      ...
      testWidgets('it_should_show_retry_button_on_error', (
        WidgetTester tester,
      ) async {
        // Given: 保存失败
      ...
      testWidgets('it_should_retry_save_when_retry_tapped', (
        WidgetTester tester,
      ) async {
        // Given: 保存失败，然后成功
        mockCardApi.shouldThrowError = true;
      ...
      testWidgets('it_should_preserve_editor_state_on_error', (
        WidgetTester tester,
      ) async {
        // Given: 保存失败
        mockCardApi.shouldThrowError = true;
    ...
    group('Navigation Tests', () {
      testWidgets('it_should_show_complete_button_in_appbar', (
        WidgetTester tester,
      ) async {
        // Given: 用户在卡片编辑器
        await tester.pumpWidget(createEditorWithMockApi());
      ...
      testWidgets('it_should_show_discard_confirmation_dialog', (
        WidgetTester tester,
      ) async {
        // Given: 用户有未保存的更改
        await tester.pumpWidget(createEditorWithMockApi());
      ...
      testWidgets('it_should_return_to_home_on_discard_confirm', (
        WidgetTester tester,
      ) async {
        // Given: 确认对话框显示
        await tester.pumpWidget(
      ...
      testWidgets('it_should_keep_editor_open_on_discard_cancel', (
        WidgetTester tester,
      ) async {
        // Given: 确认对话框显示
        await tester.pumpWidget(createEditorWithMockApi());
