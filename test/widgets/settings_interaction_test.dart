...
void main() {
  group('Settings Widget Interaction Tests', () {
    ...
    testWidgets('WT-017: Tap dark mode switch toggles state', (tester) async {
    ...
    testWidgets('WT-018: Tap export button shows dialog', (tester) async {
    ...
    testWidgets('WT-020: Confirm export proceeds', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: Builder(
    ...
    testWidgets('WT-021: Cancel export closes dialog', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: Builder(
    ...
    testWidgets('WT-032: Export success shows toast', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: Builder(
    ...
    testWidgets('WT-033: Export failure shows error', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: Builder(
    ...
    testWidgets('WT-035: Import failure shows error', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: Builder(
