...
void main() {
  group('SyncStatusIndicator Widget Tests', () {
    testWidgets('it_should_display_disconnected_state', (WidgetTester tester) async {
    ...
    testWidgets('it_should_show_rotation_animation_when_syncing', (WidgetTester tester) async {
    ...
    testWidgets('it_should_not_show_rotation_animation_when_not_syncing', (WidgetTester tester) async {
    ...
    testWidgets('it_should_display_relative_time_just_now', (WidgetTester tester) async {
      final status = SyncStatus.synced(
    ...
    testWidgets('it_should_display_relative_time_minutes', (WidgetTester tester) async {
      final status = SyncStatus.synced(
    ...
    testWidgets('it_should_display_relative_time_hours', (WidgetTester tester) async {
      final status = SyncStatus.synced(
    ...
    testWidgets('it_should_display_relative_time_days', (WidgetTester tester) async {
      final status = SyncStatus.synced(
    ...
    testWidgets('it_should_display_syncing_without_peer_count', (WidgetTester tester) async {
