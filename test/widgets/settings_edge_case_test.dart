...
void main() {
  group('Settings Widget Edge Case Tests', () {
    ...
    testWidgets('WT-036: Handle null sync notification value', (tester) async {
    ...
    testWidgets('WT-037: Handle null dark mode value', (tester) async {
      // Test with missing key in SharedPreferences
      SharedPreferences.setMockInitialValues({});
    ...
    testWidgets('WT-039: Handle invalid file format', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: Builder(
    ...
    testWidgets('WT-040: Handle file permission denied', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: Builder(
    ...
    testWidgets('WT-041: Handle import with 0 cards', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: Builder(
    ...
    testWidgets('WT-042: Handle settings load timeout', (tester) async {
    ...
    testWidgets('WT-043: Handle settings save failure', (tester) async {
      final provider = SettingsProvider();
      await provider.initialize();
    ...
    testWidgets('WT-044: Handle corrupted settings data', (tester) async {
    ...
    testWidgets('WT-045: Handle missing app info', (tester) async {
    ...
    testWidgets('WT-046: Handle empty contributors list', (tester) async {
      final provider = AppInfoProvider();
    ...
    testWidgets('WT-047: Handle empty changelog', (tester) async {
      final provider = AppInfoProvider();
      const emptyInfo = AppInfo(
        version: '1.0.0',
        buildNumber: '1',
    ...
    testWidgets('WT-048: Handle very long changelog', (tester) async {
      final provider = AppInfoProvider();
