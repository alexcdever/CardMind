...
Map<String, String> _productionSources() {
  return <String, String>{
    'CardsPage': readSource('lib/features/cards/cards_page.dart'),
    'PoolPage': readSource('lib/features/pool/pool_page.dart'),
    'CardsController': readSource('lib/features/cards/cards_controller.dart'),
    'PoolController': readSource('lib/features/pool/pool_controller.dart'),
  };
}
