...
void main() {
  group('VerificationCodeService Tests', () {
    ...
    test('it_should_generateCode returns 6-digit code', () {
    ...
    test('it_should_generateCode returns different codes', () {
      final codes = <String>{};
    ...
    test('it_should_createSession creates valid session', () {
    ...
    test('it_should_createSession sets 5-minute expiration', () {
      final session = service.createSession(
        remotePeerId: '12D3KooWTest',
        remoteDeviceName: 'Test Device',
      );
    ...
    test('it_should_verifyCode returns true for correct code', () {
      final session = service.createSession(
        remotePeerId: '12D3KooWTest',
        remoteDeviceName: 'Test Device',
      );
    ...
    test('it_should_verifyCode returns false for incorrect code', () {
    ...
    test('it_should_verifyCode returns false for non-existent session', () {
      final result = service.verifyCode(
    ...
    test('it_should_getSession returns existing session', () {
    ...
    test('it_should_getSession returns null for non-existent session', () {
      final session = service.getSession('12D3KooWNonExistent');

      expect(session, isNull);
    });

    test('it_should_cancelSession removes session', () {
      service
        ..createSession(
          remotePeerId: '12D3KooWTest',
          remoteDeviceName: 'Test Device',
    ...
    test('it_should_createSession replaces existing session for same peer', () {
    ...
    test('it_should_remainingSeconds calculates correctly', () {
      final session = service.createSession(
        remotePeerId: '12D3KooWTest',
        remoteDeviceName: 'Test Device',
      );
    ...
    test('it_should_remainingPercentage calculates correctly', () {
      final session = service.createSession(
        remotePeerId: '12D3KooWTest',
        remoteDeviceName: 'Test Device',
      );
    ...
    test('it_should_sessionStateChanges emits events', () async {
    ...
    test('it_should_verifyCode emits status change event', () async {
      final events = <VerificationSession>[];
      service.sessionStateChanges.listen(events.add);
  ...
  group('VerificationCodeManager Tests', () {
    ...
    test('it_should_returns singleton instance', () {
    ...
    test('it_should_reset creates new instance', () {
      final instance1 = VerificationCodeManager.instance;
