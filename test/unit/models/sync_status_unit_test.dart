...
void main() {
  group('SyncStatus Model Tests', () {
    ...
    group('Equality and HashCode', () {
      test('it_should_should have correct equality', () {
      ...
      test('it_should_should have correct hashCode', () {
        final time = DateTime.now();
        final status1 = SyncStatus.synced(lastSyncTime: time);
        final status2 = SyncStatus.synced(lastSyncTime: time);
    ...
    group('Helper Properties', () {
      test('it_should_isActive should return true for syncing and synced', () {
    ...
    group('Error Types', () {
      test('it_should_should have correct error messages', () {
    ...
    group('State Transition Validation', () {
      test('it_should_notYetSynced can transition to syncing or failed', () {
        final status = SyncStatus.notYetSynced();
      ...
      test('it_should_syncing can transition to synced or failed', () {
        final status = SyncStatus.syncing();
      ...
      test('it_should_synced can transition to syncing or failed', () {
      ...
      test('it_should_failed can only transition to syncing', () {
