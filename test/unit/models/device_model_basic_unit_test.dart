...
void main() {
  group('Device Model Tests', () {
    test('it_should_Device creation with all fields', () {
      final device = Device(
        id: 'test-peer-id',
        name: 'Test Device',
    ...
    test('it_should_Device isOnline property', () {
    ...
    test('it_should_Device with empty multiaddrs', () {
      final device = Device(
        id: 'test-3',
  ...
  group('DeviceType Enum Tests', () {
    test('it_should_All device types exist', () {
  ...
  group('DeviceStatus Enum Tests', () {
    test('it_should_All device statuses exist', () {
