...
void main() {
  group('HomeScreen Integration Tests - Note CRUD Flow', () {
    ...
    testWidgets('should create a new note', (WidgetTester tester) async {
      // Initialize provider
    ...
    testWidgets('should display created notes', (WidgetTester tester) async {
      // Initialize provider
      await cardProvider.initialize('/test/path');
    ...
    testWidgets('should update a note', (WidgetTester tester) async {
      // Initialize provider
      await cardProvider.initialize('/test/path');
    ...
    testWidgets('should delete a note', (WidgetTester tester) async {
      // Initialize provider
      await cardProvider.initialize('/test/path');
    ...
    testWidgets('should handle complete CRUD cycle', (
      WidgetTester tester,
    ) async {
      // Initialize provider
      await cardProvider.initialize('/test/path');
    ...
    testWidgets('should handle multiple notes CRUD', (
      WidgetTester tester,
    ) async {
      // Initialize provider
      await cardProvider.initialize('/test/path');
