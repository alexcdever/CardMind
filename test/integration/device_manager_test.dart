...
void main() {
  group('HomeScreen Integration Tests - Device Management', () {
    testWidgets('should display current device info', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('should rename current device', (WidgetTester tester) async {
      String? newName;
      final currentDevice = DeviceInfo(
        id: 'device-1',
        name: 'My Phone',
    ...
    testWidgets('should display paired devices list', (
      WidgetTester tester,
    ) async {
      final currentDevice = DeviceInfo(
        id: 'device-1',
    ...
    testWidgets('should show device online/offline status', (
      WidgetTester tester,
    ) async {
      final currentDevice = DeviceInfo(
        id: 'device-1',
    ...
    testWidgets('should open add device dialog', (WidgetTester tester) async {
      final currentDevice = DeviceInfo(
        id: 'device-1',
        name: 'My Phone',
        type: DeviceType.phone,
    ...
    testWidgets('should remove paired device', (WidgetTester tester) async {
    ...
    testWidgets('should display empty state when no paired devices', (
      WidgetTester tester,
    ) async {
      final currentDevice = DeviceInfo(
        id: 'device-1',
    ...
    testWidgets('should show correct device type icons', (
      WidgetTester tester,
    ) async {
      final currentDevice = DeviceInfo(
        id: 'device-1',
