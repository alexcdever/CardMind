...
void main() {
  group('Settings Accessibility Tests', () {
    ...
    testWidgets('it_should_AT-001: Toggle has semantic label', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('it_should_AT-002: Button has semantic label', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('it_should_AT-003: Components have proper semantic structure', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(createToggleWidget());
      await tester.pumpAndSettle();
    ...
    testWidgets('it_should_AT-004: Keyboard navigation works with Tab', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(createToggleWidget());
      await tester.pumpAndSettle();
    ...
    testWidgets('it_should_AT-005: Touch targets are at least 40x40', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(createToggleWidget());
      await tester.pumpAndSettle();
    ...
    testWidgets('it_should_AT-006: Button touch target is at least 40x40', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(createButtonWidget());
      await tester.pumpAndSettle();
    ...
    testWidgets('it_should_AT-007: Text contrast is sufficient', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(createToggleWidget());
      await tester.pumpAndSettle();
    ...
    testWidgets('it_should_AT-008: Focus indicators are visible', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(createToggleWidget());
      await tester.pumpAndSettle();
    ...
    testWidgets('it_should_AT-009: Semantic nodes exist for screen reader', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(createToggleWidget());
      await tester.pumpAndSettle();
    ...
    testWidgets('it_should_AT-010: Switches have proper semantics', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(createToggleWidget());
      await tester.pumpAndSettle();
    ...
    testWidgets('it_should_AT-011: Buttons have proper semantics', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(createButtonWidget());
      await tester.pumpAndSettle();
    ...
    testWidgets(
      'it_should_AT-012: Color is not the only means of conveying information',
    ...
    testWidgets('it_should_AT-013: Semantic labels are descriptive', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(createToggleWidget());
      await tester.pumpAndSettle();
    ...
    testWidgets('it_should_AT-014: Disabled elements are properly marked', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(createToggleWidget());
      await tester.pumpAndSettle();
    ...
    testWidgets('it_should_AT-015: Text is readable at default size', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(createToggleWidget());
      await tester.pumpAndSettle();
    ...
    testWidgets('it_should_AT-016: Info widget has proper semantics', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('it_should_AT-019: Components render without errors', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(createToggleWidget());
      await tester.pumpAndSettle();
    ...
    testWidgets('it_should_AT-020: All components have icons', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(createToggleWidget());
      await tester.pumpAndSettle();
