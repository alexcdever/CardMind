...
void main() {
  group('NoteEditorFullscreen Widget Tests - Rendering', () {
    testWidgets('it_should_WT-001: 测试基本渲染（新建模式）', (tester) async {
    ...
    testWidgets('it_should_WT-002: 测试基本渲染（编辑模式）', (tester) async {
    ...
    testWidgets('it_should_WT-004: 测试标题输入框', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: NoteEditorFullscreen(
    ...
    testWidgets('it_should_WT-005: 测试内容输入框', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: NoteEditorFullscreen(
    ...
    testWidgets('it_should_WT-006: 测试元数据渲染（编辑模式）', (tester) async {
      const testCard = bridge.Card(
        id: 'test-id',
        title: '测试标题',
        content: '测试内容',
    ...
    testWidgets('it_should_WT-007: 测试元数据渲染（新建模式）', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: NoteEditorFullscreen(
    ...
    testWidgets('it_should_WT-008: 测试工具栏高度', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: NoteEditorFullscreen(
    ...
    testWidgets('it_should_WT-009: 测试背景模糊效果', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: NoteEditorFullscreen(
    ...
    testWidgets('it_should_WT-010: 测试全屏布局', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: NoteEditorFullscreen(
    ...
    testWidgets('it_should_WT-011: 测试关闭状态', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: NoteEditorFullscreen(
    ...
    testWidgets('it_should_WT-012: 测试时间格式', (tester) async {
      const testCard = bridge.Card(
        id: 'test-id',
        title: '测试标题',
        content: '测试内容',
  ...
  group('NoteEditorFullscreen Widget Tests - Interaction', () {
    testWidgets('it_should_WT-013: 测试输入标题', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: NoteEditorFullscreen(
    ...
    testWidgets('it_should_WT-014: 测试输入内容', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: NoteEditorFullscreen(
    ...
    testWidgets('it_should_WT-015: 测试点击完成按钮（有效内容）', (tester) async {
      var closeCalled = false;
      bridge.Card? savedCard;
    ...
    testWidgets('it_should_WT-016: 测试点击完成按钮（空内容）', (tester) async {
      var closeCalled = false;
      bridge.Card? savedCard;
    ...
    testWidgets('it_should_WT-017: 测试点击关闭按钮（无更改）', (tester) async {
      var closeCalled = false;
    ...
    testWidgets('it_should_WT-018: 测试点击关闭按钮（有更改）', (tester) async {
      // ignore: unused_local_variable
      var closeCalled = false;
    ...
    testWidgets('it_should_WT-021: 测试确认对话框 - 取消', (tester) async {
      var closeCalled = false;
    ...
    testWidgets('it_should_WT-019: 测试确认对话框 - 保存并关闭', (tester) async {
      var closeCalled = false;
      bridge.Card? savedCard;
    ...
    testWidgets('it_should_WT-020: 测试确认对话框 - 放弃更改', (tester) async {
      var closeCalled = false;
      // ignore: unused_local_variable
      bridge.Card? savedCard;
    ...
    testWidgets('it_should_WT-022: 测试自动保存触发', (tester) async {
      bridge.Card? savedCard;
    ...
    testWidgets('it_should_WT-023: 测试自动保存防抖', (tester) async {
      var saveCount = 0;
    ...
    testWidgets('it_should_WT-024: 测试完成按钮取消自动保存', (tester) async {
      var saveCount = 0;
    ...
    testWidgets('it_should_WT-025: 测试空标题自动填充', (tester) async {
      bridge.Card? savedCard;
    ...
    testWidgets('it_should_WT-026: 测试新建模式空内容关闭', (tester) async {
      var closeCalled = false;
    ...
    testWidgets('it_should_WT-027: 测试编辑模式空内容关闭', (tester) async {
      // ignore: unused_local_variable
      var closeCalled = false;
      bridge.Card? savedCard;
    ...
    testWidgets('it_should_WT-028: 测试快速连续点击完成按钮', (tester) async {
      var saveCount = 0;
      var closeCalled = false;
    ...
    testWidgets('it_should_WT-029: 测试打开动画', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: NoteEditorFullscreen(
    ...
    testWidgets('it_should_WT-030: 测试关闭动画', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: NoteEditorFullscreen(
  ...
  group('NoteEditorFullscreen Widget Tests - Edge Cases', () {
    testWidgets('it_should_WT-031: 测试返回键行为', (tester) async {
      var closeCalled = false;
    ...
    testWidgets('it_should_WT-032: 测试确认对话框外部点击', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: NoteEditorFullscreen(
    ...
    testWidgets('it_should_WT-033: 测试超长标题', (tester) async {
      bridge.Card? savedCard;
    ...
    testWidgets('it_should_WT-034: 测试超长内容', (tester) async {
      bridge.Card? savedCard;
    ...
    testWidgets('it_should_WT-035: 测试标题只有空格', (tester) async {
      bridge.Card? savedCard;
    ...
    testWidgets('it_should_WT-036: 测试内容只有空格（新建模式）', (tester) async {
      var closeCalled = false;
    ...
    testWidgets('it_should_WT-037: 测试内容只有空格（编辑模式）', (tester) async {
      bridge.Card? savedCard;
    ...
    testWidgets('it_should_WT-038: 测试内容只有换行符', (tester) async {
      bridge.Card? savedCard;
    ...
    testWidgets('it_should_WT-039: 测试 card 为 null', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: NoteEditorFullscreen(
    ...
    testWidgets('it_should_WT-040: 测试 card 不为 null', (tester) async {
      const testCard = bridge.Card(
        id: 'test-id',
        title: '测试标题',
        content: '测试内容',
    ...
    testWidgets('it_should_WT-041: 测试无 SafeArea', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
    ...
    testWidgets('it_should_WT-042: 测试有 SafeArea', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: SafeArea(
    ...
    testWidgets('it_should_WT-043: 测试自动保存期间关闭', (tester) async {
      // ignore: unused_local_variable
      var closeCalled = false;
      // ignore: unused_local_variable
      bridge.Card? savedCard;
    ...
    testWidgets('it_should_WT-044: 测试确认对话框保存空内容', (tester) async {
      bridge.Card? savedCard;
    ...
    testWidgets('it_should_WT-045: 测试元数据缺失字段', (tester) async {
      const testCard = bridge.Card(
        id: 'test-id',
        title: '测试标题',
        content: '测试内容',
