...
void main() {
  group('ResponsiveBreakpoints', () {
    test('it_should_should have correct breakpoint values', () {
  ...
  group('ResponsiveUtils - Different Window Sizes', () {
    ...
    testWidgets('it_should_should detect portrait orientation', (tester) async {
    ...
    testWidgets('it_should_should not meet minimum size for small windows', (
      tester,
    ) async {
