...
void main() {
  group('AdaptiveTypography', () {
    testWidgets('should provide mobile text theme', (tester) async {
    ...
    testWidgets('should provide desktop text theme', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Builder(
            builder: (context) {
    ...
    test('should provide correct body font size', () {
    ...
    test('should provide correct heading font size', () {
    ...
    test('should provide correct title font size', () {
    ...
    test('should provide correct caption font size', () {
    ...
    test('should provide correct button font size', () {
    ...
    test('should provide correct line height', () {
    ...
    test('should provide correct letter spacing', () {
  ...
  group('AdaptiveTypographyExtension', () {
    testWidgets('should provide context extension methods', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Builder(
            builder: (context) {
  ...
  group('Typography Readability', () {
    testWidgets('mobile fonts should be readable', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Builder(
            builder: (context) {
    ...
    testWidgets('desktop fonts should be readable', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Builder(
            builder: (context) {
    ...
    testWidgets('font size differences should be appropriate', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Builder(
            builder: (context) {
