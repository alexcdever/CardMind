...
void main() {
  group('Responsive Layout Tests - Breakpoint Switching', () {
    testWidgets('should detect mobile layout below 1024px', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('should detect desktop layout at 1024px and above', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('should switch from mobile to desktop at breakpoint', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('should switch from desktop to mobile at breakpoint', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('should handle exact breakpoint (1024px)', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('should use AdaptiveBuilder correctly', (
      WidgetTester tester,
    ) async {
      // Mobile size
      tester.view.physicalSize = const Size(800, 600);
    ...
    testWidgets('should handle multiple breakpoint switches', (
      WidgetTester tester,
    ) async {
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
    ...
    testWidgets('should handle edge cases near breakpoint', (
      WidgetTester tester,
    ) async {
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
    ...
    testWidgets('should maintain state across breakpoint switches', (
      WidgetTester tester,
    ) async {
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
