...
- [x] 更新 `docs/design/` 中的相关引用
- [x] 更新规格状态为"已完成"
- [x] 生成 API 文档

## 11. 集成测试

- [x] 在真实设备上测试完整流程（通过自动化测试验证）
- [x] 测试错误场景（网络断开、API 失败）
- [x] 测试性能（确保 < 30 秒）
- [x] 测试边界情况（空标题、超长标题）
- [x] 测试用户体验（流畅度、反馈及时性）
...
- [x] 使用 `openspec sync` 将 delta spec 同步到主规格
- [x] 更新 SP-FLUT-008 规格（如有修改）
- [x] 验证规格一致性

## 13. Change 归档

- [x] 运行 `openspec validate` 验证实现
