...
本规格定义同步屏幕,显示全面的同步信息、设备管理和同步控制,确保:
...
- [../sync_feedback/sync_details_dialog.md](../sync_feedback/sync_details_dialog.md) - 同步详情对话框
- [../p2p_sync/spec.md](../p2p_sync/spec.md) - P2P同步功能
