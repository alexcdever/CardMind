新增或删除规格文件后请同步更新下方索引。
规格文档目录，记录当前已确认的正式行为、约束与验收标准，是当前实现依据的一部分。
当前实现应以 `docs/standards/` 与本目录下规格文档为准。
新增或更新规格文件需同步登记。
...
product.md - 产品规格 - 产品级真相源（终极目标、阶段目标、目标用户、核心价值与能力边界）
user-journeys.md - 产品规格 - 旅程层下游产品规格，支撑个人多设备主路径的成立、延续与恢复校准
