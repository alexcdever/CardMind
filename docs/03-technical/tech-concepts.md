...
本文档解释了CardMind项目中的核心技术概念，面向开发人员和技术决策者。CardMind基于CRDT数据同步、WebRTC点对点通信和离线优先架构，实现多设备间的无缝数据协作。
...
### 3.1 数据一致性
- CRDT算法确保最终一致性，但短期内可能出现数据不同步
- 双数据源设计需要仔细处理同步冲突和状态一致性
- 离线操作可能导致合并冲突，需要合理的冲突解决策略
...
- [技术栈文档](0301-tech-stack.md) - 了解项目使用的技术栈
- [统一业务逻辑架构设计](0302-unified-business-logic-design.md) - 架构设计原则和分层结构
- [实现计划文档](0303-implementation-plan.md) - 查看功能实现计划
