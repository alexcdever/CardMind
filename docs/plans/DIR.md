新增或删除计划文件后请同步更新下方索引。
计划文档目录，记录已完成或历史阶段的设计草案、实现计划与相关审计/清单文档。
...
2026-02-24-agents-claude-design.md - 设计草案 - Agents/Claude 相关设计
2026-02-24-agents-claude-implementation-plan.md - 实现计划 - Agents/Claude 实施步骤
2026-02-25-fractal-doc-dir-md-check-design.md - 设计草案 - DIR.md 校验方案
2026-02-25-fractal-doc-dir-md-check-plan.md - 实现计划 - DIR.md 校验步骤
2026-02-25-fractal-documentation-design.md - 设计草案 - 文档规范设计
...
2026-03-09-ui-redesign-implementation-plan.md - 实现计划 - UI 重设计任务化实施（规格调整、主页命名、局部同步反馈、本地 TDD）
