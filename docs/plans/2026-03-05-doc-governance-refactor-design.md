...
- 分形文档检查链路：`docs/standards/documentation.md` + `docs/standards/documentation.md` + `docs/standards/documentation.md` 及其测试。
- 计划文档 TDD 关键词守卫：`docs/standards/tdd.md`。
- UI 治理文档内容守卫：`docs/standards/ui-interaction-governance.md`。
...
- 删除后仍存在旧命令引用（如 `dart run docs/standards/documentation.md --base`）。
- 计划索引残留已删除文件。
- 团队担心约束强度下降。
