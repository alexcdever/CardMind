...
| 角色 | 字体 | 用途 |
|---|---|---|
| UI | Inter / 平台系统字体 | 导航、按钮、标题等全部 UI 元素 |
| 编辑器 | JetBrains Mono / 平台等宽字体 | 桌面正文可选；移动端优先使用平台字体保证输入稳定性 |
...
| `editor-text-desktop` | 15px | 400 | 24px | — | 桌面编辑器内容 |
| `editor-text-mobile` | 16px | 400 | 24px | — | 移动编辑器内容，满足移动可读性 |
