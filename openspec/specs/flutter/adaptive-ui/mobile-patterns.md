...
This specification defines mobile-specific UI patterns and interaction models for CardMind. These patterns optimize the user experience for touch-based interaction on mobile devices (Android, iOS, iPadOS), ensuring comfortable one-handed use, appropriate touch target sizes, and mobile-native navigation patterns.
