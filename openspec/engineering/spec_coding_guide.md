...
>
> **最新结构**：参考 [directory_conventions.md](directory_conventions.md)
...
```bash
# 查看所有规格
ls -lh openspec/specs/domain/*.md openspec/specs/features/**/*.md

# 查看特定规格
cat openspec/specs/domain/card_store.md
...
根据 `openspec/specs/domain/xxx.md` 实施：
