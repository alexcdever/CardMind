...
mixin _$Card {
  ...
  String get lastEditPeer => throw _privateConstructorUsedError;
      ...
      _value.copyWith(
            ...
            poolId: freezed == poolId
                ...
                : poolId // ignore: cast_nullable_to_non_nullable
                      as String?,
            lastEditPeer: null == lastEditPeer
                ? _value.lastEditPeer
                : lastEditPeer // ignore: cast_nullable_to_non_nullable
                      as String,
          )
          as $Val,
    );
...
class _$CardImpl implements _Card {
  ...
  final String? poolId;
  @override
  final String lastEditPeer;

  @override
  String toString() {
    return 'Card(id: $id, title: $title, content: $content, createdAt: $createdAt, updatedAt: $updatedAt, deleted: $deleted, ownerType: $ownerType, poolId: $poolId, lastEditPeer: $lastEditPeer)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.ownerType, ownerType) || other.ownerType == ownerType) &&
            (identical(other.poolId, poolId) || other.poolId == poolId) &&
            (identical(other.lastEditPeer, lastEditPeer) || other.lastEditPeer == lastEditPeer));
  }

  @override
  int get hashCode =>
      Object.hash(runtimeType, id, title, content, createdAt, updatedAt, deleted, ownerType, poolId, lastEditPeer);
...
abstract class _Card implements Card {
  const factory _Card({
    ...
    final String? poolId,
    required final String lastEditPeer,
  }) = _$CardImpl;
