...
echo "  ✅ rust/tests/security_password_feature_test.rs (6 scenarios)"
echo "  ✅ rust/tests/security_p2p_discovery_feature_test.rs (6 scenarios)"
echo ""
echo "Total: 6 test files, 60 scenarios"
echo ""
...
echo "  Security Password:  6 scenarios"
echo "  Security P2P:       6 scenarios"
echo ""
